...
public class ViewConfigureConnectionSME extends ViewPart {
	...
	private void makeActions() {
		...
		actionNewSME.setText("New Repository");
		actionNewSME.setToolTipText("Configure a new Repository");
		...
		actionDeleteSME.setText("Delete Repository");
		actionDeleteSME.setToolTipText("Delete the Repository");
