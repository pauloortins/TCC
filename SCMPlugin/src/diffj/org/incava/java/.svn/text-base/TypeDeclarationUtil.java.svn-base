...
import diffj.org.incava.util.ReverseComparator;
...
public class TypeDeclarationUtil extends SimpleNodeUtil
{
    ...
    public static TreeMap matchDeclarations(ASTClassOrInterfaceBodyDeclaration[] aDecls, ASTClassOrInterfaceBodyDeclaration[] bDecls, MethodUtil methodUtil)
    {
        ...
        dubaj.tr.Ace.log("aDecls", aDecls);
        dubaj.tr.Ace.log("bDecls", bDecls);
        ...
        for (int ai = 0; ai < aDecls.length; ++ai) {
            ...
            for (int bi = 0; bi < bDecls.length; ++bi) {
                ...
                double     score = getMatchScore(aNode, bNode, methodUtil);
                if (score > 0.0) {
    ...
    public static double getMatchScore(ASTClassOrInterfaceBodyDeclaration aDecl, ASTClassOrInterfaceBodyDeclaration bDecl, MethodUtil methodUtil)
    {
        ...
        if (a == null && b == null) {
            ...
            if (a instanceof ASTMethodDeclaration) {
                ...
                // WTF?
                dubaj.tr.Ace.stack(dubaj.tr.Ace.RED, "a", a);
            }
        }
