...
import diffj.net.sourceforge.pmd.ast.JavaParserConstants;
...
public class SimpleNodeUtil
{
    ...
    public static SimpleNode findChild(SimpleNode parent, Class childType, int index)
    {
        if (parent != null) {
            ...
            if (index >= 0 && index < nChildren) {
                ...
                dubaj.tr.Ace.stack("WARNING: index " + index + " out of bounds (" + 0 + ", " + nChildren + ")");
            }
    ...
    public static void print(SimpleNode node, String prefix)
    {
        ...
        dubaj.tr.Ace.log(prefix + "<" + node.toString() + ">" + getLocation(first, last));
    }
                ...
                if (showWhitespace) {
                    ...
                    if (st != null) {
                        ...
                        while (st != null) {
                            ...
                            dubaj.tr.Ace.log(prefix + "    s[" + getLocation(st, st) + "] \"" + s + "\"");
                            st = st.next;
                        }
                    }
                }
                
                dubaj.tr.Ace.log(prefix + "    t" + getLocation(tk, tk) + " \"" + tk + "\" (" + tk.kind + ")");
            }
            else {
